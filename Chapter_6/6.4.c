...
{
    int cond = 0;
    extern struct tnode *talloc_collector[TALLOC_COLLECTOR_SIZE];
    extern int talloc_collector_counter;
...
{
    char *p = NULL;
    extern int ptr_arr_counter;
    extern char *ptr_arr[PTR_ARR_SIZE];
